        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              PRINTO™ is a team of passionate printing experts united by a shared vision: to create high-quality, personalized merchandise that helps both businesses and individuals bring their ideas to life. What started as a commitment to craftsmanship and creativity soon evolved into a full-service custom printing brand and thus, PRINTO™ was born.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Today, PRINTO™ is a trusted partner in the custom merchandise and printing industry, proudly serving both <strong className="text-foreground">B2B and B2C markets across Kuwait</strong>. From multinational corporations to entrepreneurs, students, and individuals expressing their creativity, we deliver printing solutions that are reliable, professional, and tailored to every need.
                </p>
              </div>
              <div className="bg-accent/50 rounded-2xl p-8 lg:p-12">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Our mission is simple yet powerful: <strong className="text-foreground">to help our clients tell their stories through exceptional, tailor-made products</strong>. Whether it's branded merchandise, corporate giveaways, academic documents, or personalized gifts, every product we produce is designed to leave a lasting impression.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-primary text-primary-foreground rounded-2xl p-8 lg:p-12 text-center">
              <p className="text-lg leading-relaxed">
                With access to <strong>cutting-edge printing technologies</strong>, a diverse range of premium materials, and meticulous quality control, we ensure that every order meets our promise of excellence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed text-center mb-12 max-w-3xl mx-auto">
              We believe printing should be convenient and stress-free. With PRINTO's online shop, you can configure and order your printed and bound materials from the comfort of your home. There's no need to wait in line even during peak submission periods — simply upload your files, customize your order, and place it directly online.
            </p>
            
            <div className="bg-secondary/50 rounded-2xl p-8 lg:p-12">
              <h3 className="font-serif text-2xl font-bold text-foreground mb-6">
                Academic Printing Made Simple
              </h3>
              <p className="text-muted-foreground mb-6">For academic papers and documents, we offer:</p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-foreground rounded-full"></span>
                  <span className="text-muted-foreground">A wide selection of <strong className="text-foreground">premium binding options</strong></span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-foreground rounded-full"></span>
                  <span className="text-muted-foreground">Extensive <strong className="text-foreground">customization choices</strong></span>
                </li>
                <li className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-foreground rounded-full"></span>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8 max-w-3xl mx-auto">
              As PRINTO™ continues to grow and innovate, our commitment remains unchanged: <strong className="text-foreground">to create memorable experiences through print</strong>. By combining creativity, technology, and exceptional customer service, we strive to exceed expectations with every order.
            </p>
